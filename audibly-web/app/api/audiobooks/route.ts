...
export async function GET(request: Request) {
  ...
  try {
    ...
    const dtos = catalog.map((a, i) => ({
      ...
      sections: a.sections ?? undefined,
      tags: a.tags ?? undefined,
      seriesNote: a.seriesNote ?? undefined,
      coverUrl: coverUrls[i] ?? undefined,
      addedAt: a.addedAt ?? undefined,
      sourceFileCount: a.sourceFileCount,
      sourceFileIds: a.sourceFileKeys,
      chapters: a.chapters,
      narrator: a.narrator ?? undefined,
      authorBio: a.authorBio ?? undefined,
      narratorBio: a.narratorBio ?? undefined,
      whyListen: a.whyListen ?? undefined,
      atGlance: a.atGlance ?? undefined,
